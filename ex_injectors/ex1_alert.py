...
data='{"status":"Resolved","resolutionStatus":"TruePositive","summary":"user agreed to stop clicking on his mouse","impactStatus":"NoImpact","customFields":{"businessUnit":{"order":0,"string":"Finance"},"location":{"order":1,"string":"Sydney"}}}'
data_json = json.loads(data)
h={'Content-Type': 'application/json', 'Authorization': 'Bearer ' + key}
response=requests.patch(url + '/api/case/' + case_id, headers=h, json=data_json, verify=False)
